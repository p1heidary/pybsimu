...
GTKParticleDiagExportDialog::GTKParticleDiagExportDialog( GtkWidget *window, ParticleDiagPlot *plot )
...
#endif
   gtk_file_chooser_set_current_name( GTK_FILE_CHOOSER(dialog), "particles.txt" );
